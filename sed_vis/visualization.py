...
class EventListVisualizer(object):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.highlight2_panel_loc = 50
        self.event_roll_panel_loc = 85
...
#            print(self.audio.fs,self.spec_interpolation)
            ...
            self.ax3.set_xlim(self.x[0], self.x[-1])
        ...
        if not self.publication_mode:
            ...
            ax_legend_label.text(0, 0, 'demo for visualization of Respiratory Sound by lkx', fontsize=16)
...
#                self.ax3.set_xlim(self.begin_time, self.end_time)
    ...
    def highlight2_panel_play_indicator_init(self):
        ...
        self.ax3.add_patch(self.highlight_panel_indicator_line)
        return self.highlight_panel_indicator_line,
...
#        print('example:',log_spec)
    ...
    @staticmethod
    def get_intensity(audio,sampling_rate=44100, n_fft=256, win_length=1024, hop_length=1024):
        fft_window = scipy.signal.hann(win_length, sym=False).reshape((-1, 1))
